            ...
            <div>
              <div className="mb-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center">
                    ...
                    <a href="mailto:shubhamkrchb@gmail.com" className="text-[#CCD6F6] hover:text-[#64FFDA] transition-colors duration-300">shubhamkrchb@gmail.com</a>
                  </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-[#CCD6F6]">Chandigarh, India</span>
                  </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-[#CCD6F6]">+91 85913 21882</span>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  <a href="https://github.com/Shubham-Kumar-Chandrabansi" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-[#112240] border border-[#495670] flex items-center justify-center hover:bg-[#64FFDA]/10 hover:border-[#64FFDA] transition-colors duration-300 group">
                  ...
                  <a href="https://www.linkedin.com/in/chandrabansi/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-[#112240] border border-[#495670] flex items-center justify-center hover:bg-[#64FFDA]/10 hover:border-[#64FFDA] transition-colors duration-300 group">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#CCD6F6] group-hover:text-[#64FFDA] transition-colors duration-300" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <a href="mailto:shubhamkrchb@gmail.com" className="w-10 h-10 rounded-full bg-[#112240] border border-[#495670] flex items-center justify-center hover:bg-[#64FFDA]/10 hover:border-[#64FFDA] transition-colors duration-300 group">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#CCD6F6] group-hover:text-[#64FFDA] transition-colors duration-300" viewBox="0 0 24 24" fill="currentColor">
